...
<body>
    ...
    <ul class="d-sidebar-menu">
      <li class="<?php echo e((request()->is('home')) ? 'active' : ''); ?>">
        <a href="<?php echo e(route('home')); ?>"><i data-feather="home"></i> Dashboard</a>
      </li>

    

      <li class="has_submenu <?php echo e((request()->is('investment')) ? 'active' : ''); ?>">
        <a href="#0"><i data-feather="zap"></i> Investment</a>
        <ul class="submenu">
          <li class="<?php echo e((request()->is('investment')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('investment')); ?>"><i data-feather="chevrons-right"></i></i> Investment plans</a>
          </li>
          <li class="">
            <a href="<?php echo e(route('investment')); ?>"><i data-feather="chevrons-right"></i> Invest log</a>
          </li>
        </ul> 
      </li>

      <li class="has_submenu <?php echo e((request()->is('budget0')) ? 'active' : ''); ?>">
        <a href="#0"><i data-feather="award"></i> Budgets</a>
        <ul class="submenu">
          <li class="">
            <a href="<?php echo e(route('budget0')); ?>"><i data-feather="chevrons-right"></i></i> This Week</a>
          </li>
          <li class="">
            <a href="<?php echo e(route('budget1')); ?>"><i data-feather="chevrons-right"></i> This Month</a>
          </li>
          <li class="">
            <a href="<?php echo e(route('budget2')); ?>"><i data-feather="chevrons-right"></i> This Year</a>
          </li>
        </ul> 
      </li>


      <li class="has_submenu <?php echo e((request()->is('deposit')) ? 'active' : ''); ?>">
        <a href="#0"><i data-feather="briefcase"></i> Transact</a>
        <ul class="submenu">
          <li class="">
            <a href="<?php echo e(route('deposit')); ?>"><i data-feather="chevrons-right"></i> Deposit to Digipay</a>
          </li>
          <!-- <li class="">
            <a href="<?php echo e(route('digipay')); ?>"><i data-feather="chevrons-right"></i> Another DigiPay Account</a>
          </li> -->
          <!-- <li class="">
            <a href="<?php echo e(route('mobile')); ?>"><i data-feather="chevrons-right"></i> Mobile wallet</a>
          </li> -->
          <li class="<?php echo e((request()->is('banking')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('banking')); ?>"><i data-feather="chevrons-right"></i> Another Bank</a>
          </li>
          <li class="<?php echo e((request()->is('paybill')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('paybill')); ?>"><i data-feather="chevrons-right"></i> Pay Bill</a>
          </li>
          <li class="<?php echo e((request()->is('buygoods')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('buygoods')); ?>"><i data-feather="chevrons-right"></i> Buy Goods</a>
          </li>
         
        </ul>
      </li>

      <li class="has_submenu <?php echo e((request()->is('mobile')) ? 'active' : ''); ?>">
        <a href="#0"><i data-feather="credit-card"></i> Withdraw</a>
        <ul class="submenu">
          <li class="<?php echo e((request()->is('mobile')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('mobile')); ?>"><i data-feather="chevrons-right"></i> Withdraw</a>
          </li>
          <li class="<?php echo e((request()->is('widthrawlogs')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('widthrawlogs')); ?>"><i data-feather="chevrons-right"></i> Withdraw log</a>
          </li>
        </ul>
      </li>

        <li class="<?php echo e((request()->is('savings')) ? 'active' : ''); ?>">
        <a href="<?php echo e(route('savings')); ?>"><i data-feather="list"></i> Savings</a>
      </li>

      <li class="<?php echo e((request()->is('digipay')) ? 'active' : ''); ?>">          

        <a href="<?php echo e(route('digipay')); ?>"><i data-feather="repeat"></i> Transfer money</a>
      </li>

       <li class="<?php echo e((request()->is('transferlogs')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('transferlogs')); ?>">
      ...
      <li class="<?php echo e((request()->is('transactionlogs')) ? 'active' : ''); ?>">
        <a href="<?php echo e(route('transactionlogs')); ?>"><i data-feather="file-text"></i> Transaction log</a>
      </li>
     
      <li class="">
        <a href="<?php echo e(route('contact')); ?>"><i data-feather="life-buoy"></i> Support</a>
      </li>
      <li>
        <a href="<?php echo e(route('logout')); ?>"><i data-feather="log-out"></i> Logout</a>
      </li>
    </ul>
...
<div class="mobile-bottom-menu-wrapper">
  <ul class="mobile-bottom-menu">
    <li>
      <a href="<?php echo e(route('deposit')); ?>" class="<?php echo e((request()->is('deposit')) ? 'active' : ''); ?>">
        <i class="bi bi-wallet2"></i>
        <span>Deposit</span>
      </a>
    </li>
    <li>
      <a href="<?php echo e(route('investment')); ?>" class="<?php echo e((request()->is('investment')) ? 'active' : ''); ?>">
    ...
    <li>
      <a href="<?php echo e(route('mobile')); ?>" class="<?php echo e((request()->is('mobile')) ? 'active' : ''); ?>">
        <i class="bi bi-cash-coin"></i>
        <span>Withdraw</span>
      </a>
    </li>
    <li>
      <a href="<?php echo e(route('digipay')); ?>" class="<?php echo e((request()->is('digipay')) ? 'active' : 'digipay'); ?>">
...
<?php /**PATH C:\Users\princ\Desktop\Digipay\resources\views/layouts/newui.blade.php ENDPATH**/ ?>