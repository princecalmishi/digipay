    ...
    <div class="container-fluid bg-primary text-white pt-4 pb-5 d-none d-lg-flex" style="background-color:green !important;">
        <div class="container pb-2" style="background-color: green">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo e(route('/')); ?>" class="h1 text-white mb-0">Digi<span class="text-dark">Pay</span></a>
                <div class="d-flex">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="<?php echo e(route('/')); ?>" class="nav-item nav-link active">Home</a>
                        ...
                        <a href="<?php echo e(route('features')); ?>" class="nav-item nav-link">Features</a>
                        <a href="<?php echo e(route('contact')); ?>" class="nav-item nav-link">Contact</a>
                        <a href="<?php echo e(route('login')); ?>" class="nav-item nav-link">Get Started</a>
                ...
                <div class="col-lg-6 ps-lg-5">
                    <div class="row g-5">
                        <div class="col-sm-6">
                            ...
                            <a class="btn btn-link" href="<?php echo e(route('contact')); ?>">Support</a>
                        </div>
                        <div class="col-sm-6">
...
</html><?php /**PATH C:\Users\princ\Desktop\Digipay\resources\views/layouts/lab.blade.php ENDPATH**/ ?>