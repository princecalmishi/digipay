    ...
    <div class="col-lg-6">
        <div class="site-card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                <h4 class="mb-0">Transfer to another Digipay Account</h4>
                <!-- <p class="mb-0">Current Balance :99,997,000.00 KSH</p> -->
            </div>
            <div class="card-body">@include('inc.messages')
            <form action="{{route('sendtodigipay')}}" method="post">
                    <div class="card-body">@csrf
                      ...
                      <div class="form-group mb-3">
                        <label for="example-date">Send to</label>
                        <input class="form-control" id="example-date" type="number" name="recepientacc" placeholder="Recipient Digipay Account Number">
                      </div>

                      <div class="form-group mb-3">
                        <label for="example-time">Amount</label>
                        <input class="form-control" id="example-time" type="number" name="amount" max="{{$accountsbalnce}}" placeholder="Available Balance Kes. {{$accountsbalnce}}">
                      </div>
                      <div class="form-group mb-3">
