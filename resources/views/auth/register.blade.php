    ...
    <section class="auth-section auth-section-two">
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2">Already registered?</span> <a class="btn main-btn btn-sm" href="{{route('login')}}">Login</a></p>
            </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                      ...
                      <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="" id="phone" placeholder="Phone">
                                @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                              ...
                              <input readonly type="text" readonly id="refered_by" name="refered_by" class="form-control" value="{{ $_GET['refered_by'] }}">
