    ...
    <main id="main" class="main-img">
        ...
        <div class="auth-wrapper">
            <div class="auth-top-part">
                <a href="https://invest.digitalafrica.live" class="auth-logo">
                    <img class="img-fluid rounded sm-device-img text-align" src="https://invest.digitalafrica.live/asset/theme3/images/logo/whitelogo.PNG"
                        width="100%" alt="pp">
                </a>
            ...
            <div class="auth-body-part">
                <div class="auth-form-wrapper">
                    ...
                    <button class="btn main-btn w-100 mt-3" type="submit"> Reset Now </button>
                    </form>
                </div>
            </div>
