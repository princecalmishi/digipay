    ...
    <main id="main" class="main-img">
        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-body-part">
                <div class="auth-form-wrapper">@include('inc.messages')
                    <h3 class="text-center mb-4">Verify Email to Login your account</h3>
                    <form method="POST" action="{{ route('login') }}">@csrf
                        <div class="mb-3">
                            <label for="formGroupExampleInput"> {{ __('Before proceeding, please check your email for a verification link.') }}
                        ...
                        @csrf
                        <button type="submit" class="btn main-btn w-100 mt-3">{{ __('click here to request another') }}</button>.
                    </form>
                    <center><label for="formGroupExampleInput"> <a href="{{route('logout')}}">or Logout</a> </label></center>
                </div>
            </div>
