...
<div class="site-card">        
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
        <h5 class="mb-sm-0 mb-2">Transaction logs</h5>
            ...
            <table class="table site-table">
                ...
                @foreach($data as $data)
                        ...
                        <tr>
                            ...
                            <td data-caption="Amount">{{$data->category}} </td>
                            <td data-caption="Currency">{{$data->reason}} </td>
                            <td data-caption="Currency">{{$data->type}} </td>
                            <td data-caption="Charge"> Complete</td>                            
                        </tr>
                        @endforeach
                        @else
