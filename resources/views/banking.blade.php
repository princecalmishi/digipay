            ...
            <div class="card-body">@include('inc.messages')
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <input class="form-control" id="example-date" type="text" name="bankname" placeholder="Bank Name">
                      </div>

                      <div class="form-group mb-3">
                        <label for="example-date">Send to</label>
                        <input class="form-control" id="example-date" type="number" name="bankaccountnumber" placeholder="Bank Account Number">
                      </div>

                      <div class="form-group mb-3">
                        <label for="example-date">Send to</label>
                        <input class="form-control" id="example-date" type="text" name="bankaccname" placeholder="Bank Account Name">
                      </div>
