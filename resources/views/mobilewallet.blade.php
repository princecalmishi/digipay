    ...
    <div class="col-lg-6">
        <div class="site-card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                <h4 class="mb-0">Widthraw to Mobile Wallet</h4>
                <!-- <p class="mb-0">Current Balance :99,997,000.00 KSH</p> -->
            </div>
            <div class="card-body">@include('inc.messages')
            <form action="{{route('sendtomobile')}}" method="post">@csrf
                    <div class="card-body">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <input class="form-control" id="example-date" type="phone" name="recepientacc" placeholder="Mobile Phone Number">
                      </div>
