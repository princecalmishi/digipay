    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-caption">Manage plan</li>
                ...
                <li class="nav-item dropdown {{ (request()->is('admin/plans')) ? 'active' : '' }}">
                    <a href="{{route('admin/plans')}}" class="nav-link ">
                        <i data-feather="box"></i>
                        <span>Manage plan</span>
                    </a>
                </li>
                <li class="nav-item dropdown {{ (request()->is('admin/plancategories')) ? 'active' : '' }}">
                    <a href="{{route('admin/plancategories')}}" class="nav-link ">
                        <i data-feather="box"></i>
                ...
                <li class="sidebar-menu-caption">User Savings</li>
                    ...
                    <li class="nav-item dropdown {{ (request()->is('admin/usergoals')) ? 'active' : '' }}">
                        <a href="{{route('admin/usergoals')}}" class="nav-link ">
                            <i data-feather="box"></i>
                            <span>User Goals</span>
                        </a>
                    </li>
                    <li class="nav-item dropdown {{ (request()->is('admin/plancategories')) ? 'active' : '' }}">
                        <a href="{{route('admin/fixedsavings')}}" class="nav-link ">
            ...
            <li class="sidebar-menu-caption">User management</li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <!-- <li class="{{ (request()->is('admin/kyc')) ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('admin/kyc')}}">Kyc setting</a>
                        </li>


                        <li class="{{ (request()->is('admin/kycrequest')) ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('admin/kycrequest')}}">Kyc request</a>
                        </li> -->
                    ...
                    <li class="nav-item dropdown {{ (request()->is('admin/kycrequest')) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i data-feather="inbox"></i>
                        <span>Ticket</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="{{ (request()->is('admin/alltickets')) ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('admin/alltickets')}}">All tickets</a>
                        </li>
                        <li class="{{ (request()->is('admin/pendingtickets')) ? 'active' : '' }}">
                            <a class="nav-link"
                                href="{{route('admin/pendingtickets')}}">Pending ticket</a>
                        </li>
                    </ul>
                </li>
            ...
            <!--  <li class="sidebar-menu-caption">Payment and payout</li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ (request()->is('admin/pendingwith')) ? 'active' : '' }}">
                            <a class="nav-link"
                                href="{{route('admin/pendingwith')}}">Pending withdraws</a>
                        </li>
                        <li class="">
                            <a class="nav-link"
                                href="{{route('admin/approvedwith')}}">Approved withdraws</a>
                        </li>
                        <li class="">
                            <a class="nav-link"
                                href="{{route('admin/rejectedwith')}}">Rejected withdraws</a>
                        </li>
                    </ul>
                </li>
                            ...
                            <li class="nav-item dropdown ">
                                <a href="{{route('admin/managedeposits')}}" class="nav-link ">
         ...
         -->
                ...
                <li class="nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu">
                        <li class="">
                            <a class="nav-link"
                                href="{{route('admin/generalsettings')}}">General settings</a>
                        </li>
                       

                        <li>
                            <a class="nav-link"
                                href="{{route('cacheclear')}}">Cache clear</a>
                        </li>
                    </ul>
                </li>
