...
<div class="mobile-page-header">
    <h5 class="title">Buy Goods - Till Number</h5>
        ...
        <div class="site-card">
            ...
            <div class="card-body">@include('inc.messages')
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-3">
                        <label for="example-date">BuyGoods Till</label>
                        <input class="form-control" id="example-date" type="number" name="tillnumber" placeholder="Till Number">
                      </div>
