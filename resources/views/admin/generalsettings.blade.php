                ...
                <div class="col-md-12 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('admin/gensettpost')}}" method="post" enctype="multipart/form-data">@csrf
                                ...
                                <div class="row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" name="sitename" placeholder="site name"
                                            class="form-control form_control" value="{{$sname}}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="minwid" class="form-control"
                                            placeholder="Minimum Widthrawal" value="{{$min_wid}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" name="maxwid" class="form-control"
                                            placeholder="Maximum Widthrawal" value="{{$max_wid}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <input type="email" name="site_email" class="form-control form_control" value="{{$mailsent_from}}">
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <input type="text" name="smtp_username" class="form-control" value="{{$Smtp_username}}">
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <input type="password" name="smtp_password" class="form-control" value="{{$Smtp_password}}">
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <select name="Smtp_encryption" id="" class="form-control">
                                            ...
                                            <option selected value="{{$Smtp_encryption}}">{{$Smtp_encryption}}</option>
                                    ...
                                    <div class="col-md-4 my-3">
                                        ...
                                        <input type="text" name="location" class="form-control" value="{{$email}}">
                                    </div>
